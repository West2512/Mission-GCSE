        ...
        learningCards: [
          {
            ...
            body: "After reading Macbeth’s letter, Lady Macbeth immediately begins planning Duncan’s murder. While Macbeth hesitates, she becomes the driving force behind the crime and attempts to control both her husband and the situation."
          },
          {
            eyebrow: "Key quotation",
            title: "“Unsex me here”",
            body: "Lady Macbeth asks the spirits to remove the qualities traditionally associated with femininity. She believes compassion and tenderness will prevent her from carrying out the cruelty needed to gain power."
          },
          {
            eyebrow: "Writer’s method",
            title: "“Look like the innocent flower, but be the serpent under’t”",
            body: "The contrast between the innocent flower and the dangerous serpent presents deception as central to Lady Macbeth’s plan. The serpent also carries Biblical associations with temptation, evil and the fall of humanity."
          },
          {
            eyebrow: "Manipulation",
            title: "“When you durst do it, then you were a man”",
            body: "Lady Macbeth attacks Macbeth’s masculinity when he considers abandoning the murder. She manipulates his pride by suggesting that courage and manhood depend upon committing violence."
          },
          {
            eyebrow: "Deeper interpretation",
            title: "Her power is temporary",
            body: "Lady Macbeth appears commanding before Duncan’s murder, but she cannot control its psychological consequences. Shakespeare gradually reverses the couple’s roles: Macbeth becomes increasingly independent and violent, while Lady Macbeth becomes isolated and overwhelmed by guilt."
          },
          {
            eyebrow: "Context",
            title: "She challenges Jacobean expectations",
            body: "Jacobean society was strongly patriarchal, and women were generally expected to be obedient, gentle and submissive. Lady Macbeth’s rejection of femininity and her dominance over her husband may therefore have appeared deeply unnatural and threatening."
          },
          {
            eyebrow: "Exam-ready thesis",
            title: "A strong whole-play argument",
            body: "Shakespeare initially presents Lady Macbeth as an intelligent and manipulative woman who rejects traditional femininity in pursuit of power, before revealing that ambition without morality leads to guilt, isolation and psychological destruction."
          }
        ],
        questions: [
          {
            ...
            answer: 1,
            explanation:
              "Lady Macbeth immediately considers how Macbeth can gain the crown and begins preparing herself for Duncan’s murder.",
            hint:
              "She quickly focuses on the prophecy becoming reality."
          },
          {
            type: "multipleChoice",
            prompt:
            ...
            support:
              "Consider what she believes about compassion and femininity.",
            options: [
              "She wants to disguise herself as a soldier",
              "She believes feminine qualities may prevent her from committing cruelty",
              "She wants to become physically stronger than Macbeth",
              "She wishes to take Macbeth’s place as king"
            ],
            answer: 1,
            explanation:
              "Lady Macbeth associates femininity with compassion and asks for those qualities to be removed so she can pursue murder without remorse.",
            hint:
              "She wants to remove anything that might make her feel pity."
          },
          {
            type: "multipleChoice",
            prompt:
              "What does the imperative ‘unsex’ reveal about Lady Macbeth?",
            support:
              "Focus on the forceful command and her rejection of expected identity.",
            options: [
              "She passively accepts traditional expectations",
              "She forcefully rejects the gender role expected of her",
              "She is uncertain whether she wants power",
              "She believes Macbeth should rule without violence"
            ],
            answer: 1,
            explanation:
              "The forceful imperative shows Lady Macbeth actively rejecting traditional expectations of femininity in order to gain power.",
            hint:
          ...
          },
          {
            type: "multipleChoice",
            prompt:
              "Which theme is most clearly presented in ‘Look like the innocent flower, but be the serpent under’t’?",
            support:
              "Lady Macbeth tells Macbeth to hide his real intentions.",
            options: [
            ...
            answer: 0,
            explanation:
              "The quotation contrasts an innocent outward appearance with hidden evil intentions, presenting appearance versus reality.",
            hint:
              "What Macbeth shows on the outside is different from what he plans inside."
          },
          {
            type: "multipleChoice",
            prompt:
              "Why is the image of the serpent significant?",
            support:
              "Think about Biblical associations familiar to Shakespeare’s audience.",
            options: [
              "It symbolises loyalty and protection",
              "It represents temptation, deception and evil",
              "It suggests Duncan is physically weak",
              "It represents Scotland’s royal family"
            ],
            answer: 1,
            explanation:
              "The serpent recalls the Biblical serpent in the Garden of Eden, linking Lady Macbeth’s plan with temptation, deception and evil.",
            hint:
              "Think about the creature that tempted Eve."
          },
          {
            type: "multipleChoice",
            prompt:
            ...
            support:
              "Consider which part of Macbeth’s identity she attacks.",
            options: [
              "She questions his intelligence",
              "She questions his loyalty to Scotland",
              "She questions his masculinity and courage",
              "She questions his love for Duncan"
            ],
            answer: 2,
            explanation:
              "Lady Macbeth attacks Macbeth’s masculinity, suggesting that he can only prove himself a man by murdering Duncan.",
            hint:
              "She links murder with what it means to be a man."
          },
          {
            type: "multipleChoice",
            prompt:
            ...
            support:
              "Focus on the connotations of ‘milk’ and ‘kindness’.",
            options: [
              "Macbeth is physically weak",
              "Macbeth is too compassionate to seize power through murder",
              "Macbeth is loyal only to Lady Macbeth",
              "Macbeth is already prepared to kill Duncan"
            ],
            answer: 1,
            explanation:
              "Lady Macbeth fears Macbeth’s compassion and morality will stop him taking the violent action needed to become king.",
            hint:
              "She worries that he is too kind."
          },
          {
            type: "multipleChoice",
            prompt:
              "How do Lady Macbeth and Macbeth’s roles begin to change after Duncan’s murder?",
            support:
              "Think about who becomes more confident in violence and who becomes more isolated.",
            options: [
              "Lady Macbeth becomes increasingly powerful while Macbeth becomes passive",
              "Macbeth becomes more independent and violent while Lady Macbeth loses influence",
              "Both characters immediately confess their guilt",
              "Lady Macbeth becomes queen and controls every later murder"
            ],
            answer: 1,
            explanation:
              "After Duncan’s murder, Macbeth increasingly plans violence without Lady Macbeth, while she becomes isolated and psychologically vulnerable.",
            hint:
              "Macbeth later arranges Banquo’s murder without telling her."
          },
          {
            type: "multipleChoice",
            prompt:
            ...
            support:
              "Consider the imagined blood and repeated attempts to clean her hands.",
            options: [
              "She has completely forgotten Duncan’s murder",
              "Her hidden guilt has overwhelmed her mind",
              "She is still confidently controlling Macbeth",
              "She wants to become queen again"
            ],
            answer: 1,
            explanation:
              "The sleepwalking scene reveals that Lady Macbeth can no longer suppress her guilt, which returns through hallucination and compulsive behaviour.",
            hint:
              "She imagines blood that is not physically there."
          },
          {
            type: "multipleChoice",
            prompt:
              "Which thesis best answers ‘How does Shakespeare present Lady Macbeth?’",
            support:
              "Choose the answer that tracks her across the whole play.",
            options: [
              "Lady Macbeth is evil and tells Macbeth what to do.",
              "Lady Macbeth is Macbeth’s wife and wants him to be king.",
              "Shakespeare initially presents Lady Macbeth as a powerful manipulator who rejects traditional femininity, before showing guilt destroying the confidence she once displayed.",
              "Lady Macbeth changes because she sleepwalks near the end."
            ],
            answer: 2,
            explanation:
              "This thesis offers a clear whole-play argument, covers Shakespeare’s methods and tracks Lady Macbeth’s development.",
            hint:
              "The strongest answer covers both her early power and later collapse."
          }
        ]
      },
      {
